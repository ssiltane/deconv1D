% Use L1 prior regularization for deconvolution with the
...
% Maximum numbers of iterations, Matlab's default value is 200
MAXITER = 400;
...
save data/deconv08b_L1reg_many n alphavec xvec f mn recomat sig_num

deconv08b_L1reg_many_plot
