...
load data/tikhonov6c n xvec f mCF rec mCFn recn alpha recn2
...
plot(xvec,recn2,'b','linewidth',lwidth)
xlim([0 1])
title('Tikhonov reconstruction computed in two ways','fontsize',fsize)
