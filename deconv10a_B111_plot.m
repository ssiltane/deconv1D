% Plot the results of Deconv10a_B111_comp.m
%
...
load  data/deconv10_Besov111 n alpha xvec f mn recn sig_num
ymin = min(f)-.2;
ymax = max(f)+.2;
...
set(gca,'ytick',[0,1],'fontsize',fsize)
axis([0 1 ymin ymax])
title(['Besov norm penalty reconstruction, \alpha=',num2str(alpha),', error ',num2str(100*errn,'%0.1f'),'%'],'fontsize',fsize)
